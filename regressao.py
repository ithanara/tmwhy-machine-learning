...
X = df[['cerveja']] #X é sempre uma matriz, valor bidimensional
y = df['nota'] # é sempre vetor, séries

reg = linear_model.LinearRegression()
reg.fit(X,y)

#Encontrado o a e b da regressão
...
plt.legend(['Observado',
            ...
            'Árvore Depth = 2'])
# %%
#Vendo a árvore que foi criada a partir do D2 ali
plt.figure(dpi=400)
